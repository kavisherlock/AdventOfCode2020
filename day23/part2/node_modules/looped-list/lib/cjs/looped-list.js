...
class LoopedListItem {
  ...
  constructor(value, is_first = false) {
    this.value = value; // Pointers to other LoopedListItems

    this.next_item = undefined;
    this.prev_item = undefined; // Set next and prev to itself
...
class LoopedList {
  ...
  move(steps = 1) {
    steps = Math.trunc(steps); // Steps can be negative to move backwards
...
exports.LoopedList = LoopedList;
exports.LoopedListItem = LoopedListItem;
//# sourceMappingURL=looped-list.js.map
